...
namespace CarpetBG.Infrastructure.Migrations
{
    ...
    [Migration("20260216063549_AddPreLogisticSetupStatuses")]
    partial class AddPreLogisticSetupStatuses
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarpetBG.Domain.Entities.Order", b =>
                {
                    ...
                    b.ToTable("orders", null, t =>
                        {
                            t.HasCheckConstraint("ck_orders_status", "status IN ('new', 'prepickupsetup', 'pendingpickup', 'pickupcomplete', 'washinginprogress', 'washingcomplete', 'predeliverysetup', 'pendingdelivery', 'personaldelivery', 'deliverycomplete', 'cancelled', 'completed')");
                        });
                });
